...
$H_A$: CAPPUN is not dependent of OWNGUN

## Methods

<!--Decide on your methods:  use "variable analysis" or other appropriate descriptors.  Make sure to choose at least one graphical method and at least one numerical method.!-->

CAPPUN is a cat variable
OWNGUN is a cat variable, so I use the cat~cat helper file
...
This graph shows that the half of the people who own guns are in favor of them, while the more than half of the people who do not own guns are not in favor of them
...
The p-value for the Chi-squared test was p=5.3932, this means we reject/ fail to reject the null hypothesis, and conclude that the opinion on capital punishment(CAPPUN) is/ is not independent of gun ownership(OWNGUN)
